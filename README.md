...
Catplay is a realistic cryptocurrency trading simulator that lets you experience the risks and mechanics of decentralized exchanges without real financial consequences. Create coins, trade with liquidity pools, and learn about "rug pulls" in a... relatively safe environment :)

## Features
- Create & trade coins on an AMM liquidity pool market
- Predict on questions (similar to Polymarket)
- Play arcade games: Coinflip, Slots, Mines, Dice, Tower, Blackjack, Higher/Lower, Roulette and **Chicken Road**
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/outpoot/Catplay.git
   cd Catplay
   ```
...
5. **Configure Environment Variables**
   ...
   POSTGRES_DB=Catplay       # PostgreSQL database name (should match Docker config)
