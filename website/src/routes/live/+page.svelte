...
<SEO
	title="Live Trades - Catplay"
	description="Watch real-time virtual cryptocurrency trading activity in the Catplay simulation game. See live trades, user activity, and market movements as they happen."
	keywords="live crypto trades game, real-time trading simulation, virtual trading activity, crypto game stream"
/>

<svelte:head>
	<title>Live Trades - Catplay</title>
	<meta name="description" content="Real-time cryptocurrency trading activity on Catplay" />
</svelte:head>
