...
<SEO
	title={question
		? `${question.question} - Hopium - Catplay`
		: 'Loading Question - Hopium - Catplay'}
	description={question
		? `Predict "${question.question}" in Catplay's AI-powered prediction market. Current odds: ${question.yesPercentage.toFixed(1)}% YES, ${question.noPercentage.toFixed(1)}% NO. Total volume: $${question.totalAmount.toFixed(2)}.`
		: 'AI-powered prediction market question in the Catplay simulation game.'}
