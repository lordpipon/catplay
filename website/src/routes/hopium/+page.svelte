...
<SEO
	title="Hopium - Catplay"
	description="AI-powered prediction markets in the Catplay simulation game. Create yes/no questions, predict outcomes with virtual currency, and test your forecasting skills."
