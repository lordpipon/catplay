...
<SEO
	title="Shop - Catplay"
	description="Buy Gems to unlock name colors and cosmetics in Catplay. Open crates for random rewards."
	keywords="catplay shop, gems, name colors, cosmetics, crates"
/>
								...
								>
									<div class="space-y-1 text-xs">
										...
										<div class="text-muted-foreground border-t pt-1">
											Duplicate colors award Catplay money instead.
										</div>
									</div>
								</Tooltip.Content>
							</Tooltip.Root>
