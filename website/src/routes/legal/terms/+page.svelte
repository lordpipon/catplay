...
<SEO
	title="Terms of Service - Catplay"
	description="Terms of Service for Catplay - cryptocurrency trading simulation game. Learn about virtual currency, rug pull mechanics, arcade features, and platform rules."
...
<div class="container mx-auto max-w-4xl py-10">
	<Card.Root class="p-6">
		...
		<Alert.Root class="mb-6">
			...
			<Alert.Description>
				Catplay uses only virtual currency (*BUSS or "$") with no real monetary value. All trading,
		...
		<div class="space-y-2">
			<Card.Content>
				...
				<p class="mb-4">
					By accessing and using Catplay ("the Platform", "we", "us", "our"), you accept and agree
					to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you
					may not use the Platform.
				</p>
				<p>
					These Terms constitute a legally binding agreement between you and Catplay regarding your
			...
			<Card.Content>
				...
				<div class="space-y-4">
					<p>
						Catplay is a <strong>simulated cryptocurrency trading platform</strong> designed for educational
					...
					<Alert.Root class="mt-4">
						...
						<Alert.Description>
							All currency on Catplay (*BUSS, "$", and created coins) is virtual and has no
			...
			<Card.Content>
				...
				<div class="space-y-4">
					<div>
						...
						<p class="mb-3">
							You must be at least {MINIMUM_AGE} years old to use Catplay.
						</p>
					...
					<div>
						...
						<p>You may not use Catplay if you are:</p>
						<ul class="ml-6 list-disc space-y-2">
			...
			<Card.Content>
				...
				<Alert.Root class="mb-4">
					...
					<Alert.Description>
						Catplay deliberately simulates rug pull scenarios where coin creators or large holders
				...
				<div class="space-y-4">
					...
					<div>
						...
						<p class="mb-3">Trading on Catplay includes realistic mechanics such as:</p>
						<ul class="ml-6 list-disc space-y-2">
							<li>
			...
			<Card.Content>
				...
				<div class="space-y-4">
					<div>
						...
						<p class="mb-3">
							You agree to use Catplay only for lawful purposes and in accordance with these Terms.
							You will not:
						</p>
						<ul class="ml-6 list-disc space-y-2">
			...
			<Card.Content>
				...
				<div class="space-y-4">
					<div>
						...
						<p class="mb-3">Catplay includes virtual arcade entertainment features:</p>
						<ul class="ml-6 list-disc space-y-2">
			...
			<Card.Content>
				...
				<Alert.Root class="mb-4">
					...
					<Alert.Description>
						Catplay is provided "as is" without warranties. We are not liable for virtual losses,
				...
				<div class="space-y-4">
					...
					<div>
						...
						<p>Catplay is designed for educational and entertainment purposes. It is not:</p>
						<ul class="ml-6 list-disc space-y-2">
			...
			<Card.Content>
				...
				<div class="space-y-4">
					<div>
						...
						<p>Catplay and all related intellectual property are owned by us, including:</p>
						<ul class="ml-6 list-disc space-y-2">
					...
					<div>
						...
						<p class="mb-3">
							Catplay incorporates intellectual property from creator's past projects, including:
						</p>
						<ul class="ml-6 list-disc space-y-2">
						...
						<p class="text-muted-foreground mt-3 text-sm">
							All past project assets used in Catplay are owned by the platform creators or used
			...
			<Card.Content>
				...
				<p>
					By using Catplay, you consent to our data practices as described in the Privacy Policy,
				...
				<div class="space-y-4">
					<div>
						...
						<p>
							...
							you and Catplay regarding use of the Platform.
						</p>
					</div>
			...
			<div class="rounded-lg p-4 text-sm" style="background-color: oklch(var(--primary) / 0.1);">
				...
				<p class="mb-2"><strong>Platform:</strong> Catplay</p>
			</div>
		</div>
