<script lang="ts">
	...
	function getDefaultMessage(status: number) {
		switch (status) {
			case 404:
				return "This page doesn't exist. You might have followed an old link or mistyped something!";
			case 403:
...
<div class="flex min-h-[70vh] items-center justify-center gap-12">
	<div class="flex max-w-lg flex-col items-center justify-center text-center">
		...
		<div class="flex flex-col">
			<Button variant="link" href="https://discord.gg/NKzq7ppNQK" target="_blank">@Discord</Button>
		</div>
	</div>
