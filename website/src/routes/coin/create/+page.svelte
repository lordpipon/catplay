...
<SEO
	title="Create Coin - Catplay"
	description="Launch your own virtual cryptocurrency in the Catplay simulation game. Create coins with custom names, symbols, and icons."
