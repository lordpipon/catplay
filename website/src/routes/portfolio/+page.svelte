...
<SEO
	title="Portfolio - Catplay"
	description="View your virtual cryptocurrency portfolio, simulated holdings, and trading performance in the Catplay simulation game platform."
	noindex={true}
