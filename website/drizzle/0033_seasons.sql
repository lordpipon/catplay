-- Ranked seasons: tables, enums, and per-user halloween 2026 badge column.
...
CREATE INDEX "season_trophy_season_id_idx" ON "season_trophy" USING btree ("season_id");--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "halloween_badge_2026" boolean DEFAULT false NOT NULL;